...
//
//	 How to create :
// 	 	 1. The idea is to use a static member-function (static factory method) that creates & returns instances,
// 	 	 	 hiding the details of class modules from the user.
// 	 	 2. A factory pattern is one of the core design principles to create an object.
// 	 	 3. It allow clients to create objects of a library in a way such that it doesn't have tight coupling with the class hierarchy of the library.
//
