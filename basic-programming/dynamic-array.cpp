...
//             If an array has a small size and a small growth factor, it will keep on reallocating memory more often.
//             This will reduce the performance of the array.
//             If an array has a large size and a large growth factor, it will have a huge chunk of unused memory.
//             Due to this, resize operations may take longer. This will reduce the performance of the array.
...
//         Note: To delete a dynamic array from the computer memory, you should use delete[],
